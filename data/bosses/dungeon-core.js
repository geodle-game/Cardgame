...
export const LORE = {
  ...
  // Shown when the boss dies. One-shot.
  onDeath: [
    'The Core fractures.',
    'Not like a monster dying — like a shell cracking open. What was inside was never a monster. It was a keeper.',
    ...
    'You see it now. Card Magic was never stable. It was never meant to be used this long. Every card drawn, every enchantment layered, every generation that taught the next — a hairline fracture in the fabric of the world. Invisible for centuries. Now the wall is failing.',
    'Humanity did not become too strong for the dungeon to control.',
    'Humanity became strong enough to break the world, and the dungeon has spent a thousand years trying to stop them.',
    ...
    'The last of its light gathers into a single point — small, warm, patient. The same light you have felt in the amulet at your chest your entire life. You understand now. The amulet was never a gift from your family.',
    'It was a seed.',
    '"You will not live long enough to finish this as a human," the Core says. "You already know what you have to do."',
    '"Destroy the cards. Every last one. Before the wall comes down. Before the child writing her first card in that village school grows up to break the world by accident."',
    ...
    'Come and find me, you think, softly, the way a door might. When you are ready.',
    'I will be waiting.',
  ],
